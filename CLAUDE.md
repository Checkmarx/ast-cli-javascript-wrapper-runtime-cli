...
3. Merge to main with PR approval
4. Tag release: `git tag v1.0.x`
5. Push tags: `git push origin --tags`
6. GitHub Actions release workflow handles publication
...
class CxWrapper {
  ...
  // Feature modules accessed through instance methods
}
```
...
5. Tag release: `git tag v1.0.x`
6. GitHub Actions handles publication
